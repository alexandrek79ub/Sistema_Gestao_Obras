...
## 🧮 1. Demonstração Matemática Detalhada Instalações e HVAC

### 1.1 Cabeamento Elétrico Flexível 750V (Prancha EGS-013)
> **Fórmula:** `L_total = Σ (Trajeto_horizontal + Sobra_caixa 0,5m) × N_condutores × 1,10`
- **Circuitos 2,5mm² (Iluminação/TUG):** `1.850,0 m` → **21 rolos 100m** (`2.035 m`).
- **Circuitos 4,0mm² (Tomadas TUG/TUE):** `640,0 m` → **8 rolos 100m** (`704 m`).
- **Circuitos 6,0mm² (Ar Condicionado Split):** `420,0 m` → **5 rolos 100m** (`462 m`).

### 1.2 Climatização Split Inverter R410A (Prancha EGS-008)
- **Split Cassete 36.000 BTU/h (Salas Grandes):** `4 conjuntos completos`
- **Split Hi-Wall 18.000 BTU/h (Escritórios Medios):** `6 conjuntos completos`
- **Split Hi-Wall 12.000 BTU/h (Salas Pequenas/Apoio):** `6 conjuntos completos`
- **Tubulação Cobre Ø3/8"+Ø5/8":** `180,0 m` → **198,0 m**.
