# 🧱 POP 12: Alvenaria de Vedação Racionalizada

**Normas de Referência:** NBR 15270, NBR 15575.
**Objetivo:** Erigir painéis de vedação no prumo exato (reduzindo espessura de reboco) e com amarrações corretas para prevenir trincas de interface.
...
## 2. Elevação (O Fim do Prumo de Chumbo)
- **Escantilhão e Linha:** É **obrigatório** o uso de escantilhões metálicos (guias) fixados do piso ao teto nos cantos da parede. A linha esticada entre os escantilhões substitui a verificação manual de prumo bloco a bloco.
