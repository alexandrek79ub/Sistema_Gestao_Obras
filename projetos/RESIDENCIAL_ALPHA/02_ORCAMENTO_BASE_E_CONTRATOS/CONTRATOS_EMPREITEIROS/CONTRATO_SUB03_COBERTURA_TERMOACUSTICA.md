...
> **Prazo Contratual:** 35 dias corridos (Semanas S10 a S15 | 20/11/2026 a 25/12/2026) | **Governança:** POP 17 / NR-18 / Skill Gestão 10

---

## CLÁUSULA PRIMEIRA — DO OBJETO
1.1. O presente contrato tem por objeto a execução, sob o regime de **Empreitada por Preço Unitário**, dos serviços de **Empreitada Especializada de Cobertura Termoacústica e Calhas**, correspondente ao pacote **SUB-03** da Linha de Base 01 da RESIDENCIAL_ALPHA.
...
2.1. Pela execução dos serviços descritos no Anexo I, a CONTRATANTE pagará à CONTRATADA o valor global estimado de **R$ 42.500,00** (preço fechado dos serviços listados).
...
3.1. O prazo total de vigência executiva é de **35 dias corridos (Semanas S10 a S15 | 20/11/2026 a 25/12/2026)**, com início imediato após a emissão da Ordem de Serviço.
3.2. A CONTRATADA obriga-se a disponibilizar e manter no canteiro a equipe de pico de **3 montadores industriais certificados em NR-35 (Trabalho em Altura)**, sob pena de notificação e aplicação de multa por desmobilização imprevista.
...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| `1.4.1` | Montagem e fixação de terças metálicas em perfil U enrijecido galvanizado | kg | 1.850,00 | R$ 8,00 | **R$ 14.800,00** | `CC-501` |
| `1.4.2` | Montagem e fixação de telhas sandwich termoacústicas PIR 30mm trapézio | m² | 381,29 | R$ 38,00 | **R$ 14.489,02** | `CC-501` |
| `1.4.3` | Instalação de calhas metálicas galvanizadas corte 50 e condutores | m | 64,00 | R$ 45,00 | **R$ 2.880,00** | `CC-501` |
| `1.4.4` | Instalação de rufos de platibanda, cumeeiras seladas e arremates estanques | m | 82,00 | R$ 35,00 | **R$ 2.870,00** | `CC-501` |
| `1.4.5` | Mão de obra global de montagem com linha de vida e teste de mangueira | vb | 1,00 | R$ 7.460,98 | **R$ 7.460,98** | `CC-500` |

**VALOR TOTAL DO ANEXO I (REMUNERAÇÃO DA EMPREITADA):** **R$ 42.500,00**
...
- **Normas Regulamentadoras e Técnicas Aplicáveis:** ABNT NBR 14513 (Telhas de Aço Revestido), NBR 14514, NBR 10844 (Instalações Prediais de Águas Pluviais) e NR-35;
- **Tolerâncias Máximas Admissíveis:** Inclinação mínima de 5% garantida no plano de cobertura; Sobreposição longitudinal mínima de 20cm nas emendas; Caimento contínuo mínimo de 1% nas calhas em direção aos condutores pluviais;
- **Portão Bloqueante de Qualidade (FVS):** FVS-COB-01 (Fixação Estrutural e Estanqueidade da Cobertura);
...
- **A CONTRATANTE (Construtora) Fornece Exclusivamente:** Terças metálicas galvanizadas, Telhas sandwich PIR 30mm cortadas sob medida, Calhas e rufos conformados, Parafusos autobrocantes, Selante PU e Caminhão munck para içamento.;
- **A CONTRATADA (Empreiteiro) Fornece Obrigatoriamente:** Parafusadeiras elétricas profissionais a bateria, furadeiras de impacto, rebitadeiras pneumáticas, tesouras de funilaria, cintos de segurança tipo paraquedista duplo talabarte com absorvedor de energia..
