# 📄 INSTRUMENTO PARTICULAR DE CONTRATO DE EMPREITADA CIVIL: SUB-05
### EMPREITADA DE INSTALAÇÕES ELÉTRICAS, TELECOM E SPDA
...
> **Valor Total do Contrato:** R$ 48.200,00 | **Centro de Custo:** CC-604 / CC-605 / CC-606 (Instalações Elétricas)  
> **Prazo Contratual:** 60 dias corridos (Semanas S12 a S21 | 01/12/2026 a 30/01/2027) | **Governança:** POP 17 / NR-18 / Skill Gestão 10

---

## CLÁUSULA PRIMEIRA — DO OBJETO
1.1. O presente contrato tem por objeto a execução, sob o regime de **Empreitada por Preço Unitário**, dos serviços de **Empreitada de Instalações Elétricas, Telecom e SPDA**, correspondente ao pacote **SUB-05** da Linha de Base 01 da OBRA_TMULT.
1.2. O escopo compreende: Execução completa de eletrodutos rígidos embutidos, passagem de 3.800m de cabos elétricos de cobre flexível 750V/1kV, montagem e barramento dos quadros QDG e QDF, rede de cabeamento estruturado Cat6, tomadas, interruptores e luminárias LED, estritamente de acordo com as especificações técnicas, projetos executivos, cadernos de encargos e normas vigentes.

## CLÁUSULA SEGUNDA — DO VALOR E DA FORMA DE PAGAMENTO
2.1. Pela execução dos serviços descritos no Anexo I, a CONTRATANTE pagará à CONTRATADA o valor global estimado de **R$ 48.200,00** (preço fechado dos serviços listados).
...
3.1. O prazo total de vigência executiva é de **60 dias corridos (Semanas S12 a S21 | 01/12/2026 a 30/01/2027)**, com início imediato após a emissão da Ordem de Serviço.
3.2. A CONTRATADA obriga-se a disponibilizar e manter no canteiro a equipe de pico de **2 eletricistas industriais oficiais com certificação NR-10 e NR-10 SEP**, sob pena de notificação e aplicação de multa por desmobilização imprevista.
...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| `2.2.1` | Chumbamento de caixas 4x2 e eletrodutos de PVC rígido roscável embutidos | m | 650,00 | R$ 12,00 | **R$ 7.800,00** | `CC-604` |
| `2.2.3` | Enfiamento e puxamento de condutores de cobre flexível 750V de 1,5 a 50 mm² | m | 3.800,00 | R$ 4,50 | **R$ 17.100,00** | `CC-605` |
| `2.2.5` | Montagem, barramentos de cobre e fiação interna dos quadros QDG e QDF | cj | 2,00 | R$ 3.200,00 | **R$ 6.400,00** | `CC-606` |
| `2.2.6` | Instalação de 85 conjuntos de interruptores, tomadas 10A/20A e tampas 4x2 | un | 85,00 | R$ 25,00 | **R$ 2.125,00** | `CC-606` |
| `2.2.7` | Instalação de 48 luminárias de embutir LED 60x60cm e spots decorativos | un | 48,00 | R$ 35,00 | **R$ 1.680,00** | `CC-606` |
| `2.2.8` | Passagem e conectorização RJ-45 de rede de dados e telecom Cat6 (Rack 12U) | pt | 32,00 | R$ 45,00 | **R$ 1.440,00** | `CC-606` |
| `2.2.9` | Mão de obra de testes, ensaios de isolamento, etiquetagem e ART elétrica | vb | 1,00 | R$ 11.655,00 | **R$ 11.655,00** | `CC-606` |

**VALOR TOTAL DO ANEXO I (REMUNERAÇÃO DA EMPREITADA):** **R$ 48.200,00**
...
- **Normas Regulamentadoras e Técnicas Aplicáveis:** ABNT NBR 5410 (Instalações Elétricas de Baixa Tensão), NBR 5419 (Proteção contra Descargas Atmosféricas) e NR-10;
- **Tolerâncias Máximas Admissíveis:** Resistência de isolamento mínima de 1,0 MOhm medida com megômetro em todos os circuitos; Equilíbrio de fases no quadro QDG com desbalanceamento < 5%; Identificação anilhada de 100% dos condutores;
- **Portão Bloqueante de Qualidade (FVS):** FVS-ELE-01 (Inspeção de Tubulação e Quadros) e FVS-ELE-02 (Laudo de Megômetro e Continuidade com ART);
...
- **A CONTRATANTE (Construtora) Fornece Exclusivamente:** Eletrodutos PVC rígidos, Cabos elétricos Prysmian, Quadros e disjuntores Schneider, Tomadas/Interruptores, Luminárias LED, Cabos Cat6 e Rack de telecomunicações.;
- **A CONTRATADA (Empreiteiro) Fornece Obrigatoriamente:** Alicates decapadores e crimpadores de ilhós profissionais, alicates de pressão, fitas passa-fio de aço, multímetros digitais True-RMS calibrados, megômetro com laudo de calibração RBC, EPIs para arco elétrico conforme NR-10..
