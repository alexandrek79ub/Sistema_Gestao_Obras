...
> **Empreendimento:** Residencial Alpha — Condomínio Fechado (220.00 m²) — `RESIDENCIAL_ALPHA`  
...
> **Prazo Contratual:** 60 dias corridos (Semanas S01 a S09 | 22/09/2026 a 20/11/2026) | **Governança:** POP 17 / NR-18 / Skill Gestão 10

---

## CLÁUSULA PRIMEIRA — DO OBJETO
1.1. O presente contrato tem por objeto a execução, sob o regime de **Empreitada por Preço Unitário**, dos serviços de **Empreitada de Fundações e Estrutura de Concreto Armado**, correspondente ao pacote **SUB-01** da Linha de Base 01 da RESIDENCIAL_ALPHA.
...
2.1. Pela execução dos serviços descritos no Anexo I, a CONTRATANTE pagará à CONTRATADA o valor global estimado de **R$ 195.400,00** (preço fechado dos serviços listados).
...
3.1. O prazo total de vigência executiva é de **60 dias corridos (Semanas S01 a S09 | 22/09/2026 a 20/11/2026)**, com início imediato após a emissão da Ordem de Serviço.
3.2. A CONTRATADA obriga-se a disponibilizar e manter no canteiro a equipe de pico de **12 operários (4 Carpinteiros Oficiais, 3 Armadores Oficiais e 5 Serventes de Obras)**, sob pena de notificação e aplicação de multa por desmobilização imprevista.
...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| `1.1.1` | Escavação manual e ajuste fino de fundo de cavas das sapatas | m³ | 51,27 | R$ 14,28 | **R$ 732,14** | `CC-201` |
| `1.1.2` | Apiloamento e compactação do fundo de cavas e valas de fundação | m² | 60,74 | R$ 8,65 | **R$ 525,40** | `CC-201` |
| `1.1.5` | Montagem e desforma de painéis de fôrma compensado 17mm para 32 sapatas | m² | 35,88 | R$ 55,00 | **R$ 1.973,40** | `CC-204` |
| `1.1.7` | Montagem e desforma de fôrmas compensadas 17mm para arranques de pilares | m² | 25,76 | R$ 65,00 | **R$ 1.674,40** | `CC-205` |
| `1.1.9` | Montagem e desforma de fôrmas compensadas para vigas baldrames (140,44m) | m² | 112,35 | R$ 55,00 | **R$ 6.179,25** | `CC-207` |
| `1.1.10` | Armação e amarração de aço CA-50 Ø8,0mm nas 32 sapatas isoladas | kg | 256,00 | R$ 4,50 | **R$ 1.152,00** | `CC-208` |
| `1.1.11` | Armação e amarração de arranques dos pilares P1-P24 c/ gancho 30cm | kg | 145,70 | R$ 4,50 | **R$ 655,65** | `CC-209` |
| `1.1.12` | Armação e amarração de armaduras positivas/estribos vigas baldrames | kg | 1.077,30 | R$ 4,50 | **R$ 4.847,85** | `CC-210` |
| `1.1.13` | Aplicação de emulsão asfáltica impermeabilizante em sapatas e baldrames | m² | 183,36 | R$ 18,00 | **R$ 3.300,48** | `CC-211` |
| `1.2.1` | Lançamento, adensamento vibrado e acabamento de concreto usinado pilares | m³ | 6,44 | R$ 120,00 | **R$ 772,80** | `CC-301` |
| `1.2.2` | Montagem, prumo, travamento e desforma de fôrmas de pilares P1-P24 (4 faces) | m² | 85,82 | R$ 70,00 | **R$ 6.007,40** | `CC-302` |
| `1.2.3` | Lançamento e vibração de concreto fck 30 MPa vigas superiores V101-V115 | m³ | 17,38 | R$ 110,00 | **R$ 1.911,80** | `CC-301` |
| `1.2.4` | Montagem, nivelamento e desforma de fôrmas vigas superiores (fundo e laterais) | m² | 208,62 | R$ 65,00 | **R$ 13.560,30** | `CC-302` |
...
- **Normas Regulamentadoras e Técnicas Aplicáveis:** ABNT NBR 6118 (Projeto e Execução de Estruturas de Concreto), NBR 14931 (Execução de Estruturas de Concreto), NBR 7480 (Aço para Armaduras) e NR-18;
- **Tolerâncias Máximas Admissíveis:** Desaprumo máximo em pilares de 1/500 da altura (máx. 6mm para h=2,98m); Cobrimento normativo mínimo c=40mm garantido por espaçadores plásticos tipo pastilha; Flecha máxima em vigas de L/300 após desforma;
- **Portão Bloqueante de Qualidade (FVS):** FVS-EST-01 (Liberação de Fôrmas e Escoramento) e FVS-EST-02 (Conferência de Armadura e Cobrimento antes da concretagem);
...
- **A CONTRATANTE (Construtora) Fornece Exclusivamente:** Aço cortado e dobrado etiquetado (Gerdau), Concreto usinado fck 30 MPa com serviço de bombeamento (Polimix), Chapas compensadas 17mm, Cimbramento e escoras metálicas locadas, Água potável/industrial, Energia elétrica trifásica e Containers de vivência NR-18.;
- **A CONTRATADA (Empreiteiro) Fornece Obrigatoriamente:** Ferramental completo de carpintaria e armação (serras circulares de bancada com coifa homologada, torquês, vibradores de imersão de reserva, martelos, réguas de alumínio, mangueiras de nível, prumos de face e centro), EPIs completos com CA e fardamento com faixas refletivas..

---

RESIDENCIAL_ALPHA, _____ de _________________ de 2026.

____________________________________________       ____________________________________________
**Pela CONTRATANTE: Construtora Executiva**          **Pela CONTRATADA: Empreiteiro Responsável**
Nome: Eng. Residente (RESIDENCIAL_ALPHA)                       Nome: Representante Legal
