...
- 📊 **OBRIGATORIEDADE DA TABELA OFICIAL DE SERVIÇOS PARA EAP E CRONOGRAMA:** Todo levantamento quantitativo DEVE ser acompanhado da Tabela de Serviços / EAP correspondente da disciplina (níveis 1.1 a 5.1), contendo código EAP oficial, unidade de avanço físico e predecessoras bloqueantes para alimentar o cronograma e os contratos de empreiteiros. É terminantemente PROIBIDO entregar lista de compras sem o mapeamento de serviços para EAP.
