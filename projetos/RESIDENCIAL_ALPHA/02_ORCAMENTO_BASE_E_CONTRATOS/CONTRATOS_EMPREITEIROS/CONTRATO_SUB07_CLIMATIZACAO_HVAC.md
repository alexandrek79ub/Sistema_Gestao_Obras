# 📄 INSTRUMENTO PARTICULAR DE CONTRATO DE EMPREITADA CIVIL: SUB-07
### EMPREITADA DE CLIMATIZAÇÃO HVAC (INSTALAÇÃO E START-UP)
...
> **Valor Total do Contrato:** R$ 24.800,00 | **Centro de Custo:** CC-608 (Climatização e Ar-Condicionado)  
> **Prazo Contratual:** 25 dias corridos (Semanas S20 a S24 | 20/01/2027 a 20/02/2027) | **Governança:** POP 17 / NR-18 / Skill Gestão 10

---

## CLÁUSULA PRIMEIRA — DO OBJETO
1.1. O presente contrato tem por objeto a execução, sob o regime de **Empreitada por Preço Unitário**, dos serviços de **Empreitada de Climatização HVAC (Instalação e Start-up)**, correspondente ao pacote **SUB-07** da Linha de Base 01 da RESIDENCIAL_ALPHA.
1.2. O escopo compreende: Instalação completa, pressurização, vácuo e start-up de 8 unidades de ar-condicionado Split Inverter (capacidades de 12.000 a 24.000 BTU/h) com tubulações de cobre isoladas, drenos em PVC e carga de fluido refrigerante R-32, estritamente de acordo com as especificações técnicas, projetos executivos, cadernos de encargos e normas vigentes.

## CLÁUSULA SEGUNDA — DO VALOR E DA FORMA DE PAGAMENTO
2.1. Pela execução dos serviços descritos no Anexo I, a CONTRATANTE pagará à CONTRATADA o valor global estimado de **R$ 24.800,00** (preço fechado dos serviços listados).
...
3.1. O prazo total de vigência executiva é de **25 dias corridos (Semanas S20 a S24 | 20/01/2027 a 20/02/2027)**, com início imediato após a emissão da Ordem de Serviço.
3.2. A CONTRATADA obriga-se a disponibilizar e manter no canteiro a equipe de pico de **2 mecânicos de refrigeração oficiais qualificados com ART de instalação**, sob pena de notificação e aplicação de multa por desmobilização imprevista.
...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| `2.3.1` | Instalação de tubulação frigorígena de cobre sem costura isolada c/ elastomérico | m | 160,00 | R$ 35,00 | **R$ 5.600,00** | `CC-608` |
| `2.3.2` | Execução de rede de drenagem de condensado em PVC rígido soldável Ø25mm | m | 80,00 | R$ 22,00 | **R$ 1.760,00** | `CC-608` |
| `2.3.3` | Fixação de 8 evaporadoras e condensadoras com suportes metálicos c/ coxins | un | 8,00 | R$ 450,00 | **R$ 3.600,00** | `CC-608` |
| `2.3.4` | Serviço de pressurização com N2, vácuo profundo <500 microns e recolhimento | cj | 8,00 | R$ 300,00 | **R$ 2.400,00** | `CC-608` |
| `2.3.5` | Start-up, medição de corrente/tensão, teste de vazão de ar e emissão de ART | vb | 1,00 | R$ 11.440,00 | **R$ 11.440,00** | `CC-608` |

**VALOR TOTAL DO ANEXO I (REMUNERAÇÃO DA EMPREITADA):** **R$ 24.800,00**
...
- **Normas Regulamentadoras e Técnicas Aplicáveis:** ABNT NBR 16401 (Instalações de Ar-Condicionado - Sistemas Centrais e Unitários) e Portaria 3.523/MS (PMOC);
- **Tolerâncias Máximas Admissíveis:** Vácuo final atingido abaixo de 500 microns mantido estável por no mínimo 30 minutos; Pressurização de teste com Nitrogênio a 400 psi sem vazamento nas conexões flangeadas; Diferencial de temperatura (Delta T) entre 8ºC e 12ºC em regime;
- **Portão Bloqueante de Qualidade (FVS):** FVS-VAC-01 (Laudo de Desidratação e Comissionamento de Climatização c/ ART);
...
- **A CONTRATANTE (Construtora) Fornece Exclusivamente:** 8 Aparelhos de ar-condicionado Split Inverter R-32 homologados, Tubos de cobre em rolos, Isolamento elastomérico Armaflex, Fitas aluminizadas e Suportes metálicos.;
- **A CONTRATADA (Empreiteiro) Fornece Obrigatoriamente:** Bomba de vácuo de duplo estágio 10 CFM, Vacuômetro digital de alta precisão (ex: Fieldpiece/Testo), Manifold digital específico para R-32, Garrafa de Nitrogênio com regulador de alta pressão, Flangeador excêntrico profissional e torquímetro..
