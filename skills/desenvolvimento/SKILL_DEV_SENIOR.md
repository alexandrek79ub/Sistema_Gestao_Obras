...
| Arquitetura do Sistema | `MANUAL_DO_ECOSSISTEMA.md` | Visão geral e fluxo de dados |
| Schema e Contratos | [`SKILL_DEV_SCHEMA_CSV.md`](file:///c:/Users/Alexandre/Workspace/A11_SISTEMA_DE_GESTAO_OBRAS/skills/desenvolvimento/SKILL_DEV_SCHEMA_CSV.md) | Contrato do banco SQLite e especificações das exportações derivadas (CSV/Excel) |
...
| Banco de Dados (SSOT) | `data/pmo_virtual.sqlite` (SQLite central) | **ÚNICA Fonte da Verdade** dos dados de obra; Dashboard consome via `@/lib/db.ts` |
