...
> **Planilha de Gestão e Controle:** [`PLANILHA_GESTAO_LOCACAO_EQUIPAMENTOS.xlsx`](file:///C:/Users/Alexandre/Workspace/A11_SISTEMA_DE_GESTAO_OBRAS/projetos/RESIDENCIAL_ALPHA/02_ORCAMENTO_BASE_E_CONTRATOS/CONTRATOS_EQUIPAMENTOS/PLANILHA_GESTAO_LOCACAO_EQUIPAMENTOS.xlsx)
...
| :---: | :--- | :---: | :--- | :---: | :---: | :---: |
| **[LOC-01](CONTRATO_LOC01_MODULOS_HABITAVEIS_NR18.md)** | CONTRATO DE LOCAÇÃO DE MÓDULOS HABITÁVEIS CONTAINERS E ... | `EQ-01 (Escritório), EQ-02 (Ves...` | Rentcon Locações de Módulos Habitáveis Ltda | 22/09/2026 a 10/03/202 | `CC-103` | **R$ 38,299.98** |
| **[LOC-02](CONTRATO_LOC02_TERRAPLENAGEM_E_TRANSPORTE.md)** | CONTRATO DE LOCAÇÃO DE MAQUINÁRIO PESADO DE TERRAPLENAG... | `EQ-06 (Retroescavadeira 4x4) e...` | Terramax Locações e Terraplenagem do Norte Fluminense Ltda | 19/09/2026 a 08/10/202 | `CC-201` | **R$ 24,500.00** |
| **[LOC-03](CONTRATO_LOC03_GRUPO_GERADOR_SILENCIADO.md)** | CONTRATO DE LOCAÇÃO DE GRUPO GERADOR DIESEL SILENCIADO ... | `EQ-17 (Grupo Gerador Diesel Si...` | Tecnogera Locação de Geradores e Energia Temporária S.A. | 18/09/2026 a 10/12/202 | `CC-104` | **R$ 19,800.00** |
| **[LOC-04](CONTRATO_LOC04_CIMBRAMENTO_E_ESCORAMENTO.md)** | CONTRATO DE LOCAÇÃO DE SISTEMA DE CIMBRAMENTO E ESCORAM... | `EQ-10 (Sistema de Cimbramento ...` | Mills Estruturas e Serviços de Engenharia S.A. | 25/10/2026 a 28/11/202 | `CC-302` | **R$ 14,850.00** |
| **[LOC-05](CONTRATO_LOC05_ANDAIMES_E_PLATAFORMA_ELEVATORIA.md)** | CONTRATO DE LOCAÇÃO DE ANDAIMES FACHADEIROS NR-18 E PLA... | `EQ-11 (200m² Andaimes Fachadei...` | Loxam Degrau Locação de Equipamentos e Plataformas S.A. | 20/11/2026 a 20/02/202 | `CC-403` | **R$ 21,800.00** |
| **[LOC-06](CONTRATO_LOC06_EQUIPAMENTOS_ESPECIAIS_CANTEIRO.md)** | CONTRATO DE LOCAÇÃO DE EQUIPAMENTOS MECÂNICOS DE PRODUÇ... | `EQ-08 (Compactador Sapo), EQ-0...` | Casa do Construtor Locação de Ferramentas | 18/09/2026 a 25/02/202 | `CC-106, CC-201, CC-404, CC-405, CC-601, CC-608` | **R$ 22,650.00** |

**VALOR TOTAL CONSOLIDADO DE LOCAÇÃO DE MÁQUINAS E INSTALAÇÕES:** **R$ 141,899.98**

---

## 2. Protocolo de Entrada e Segurança de Equipamentos no Canteiro (POP 04)

Antes de qualquer equipamento iniciar operação no canteiro da RESIDENCIAL_ALPHA, o Engenheiro Residente e o Técnico de Segurança do Trabalho (TST) devem exigir:
