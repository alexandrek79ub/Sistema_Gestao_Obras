...
**Disciplina:** Instalações Elétricas, Telecomunicações, SPDA, Hidrossanitárias e HVAC  
**Documentos de Referência:** 
- `AÇU-3.DES-2.3100-16-EGS-013 rev.0`: Planta Baixa de Instalações Elétricas (Escala 1:50) e Cobertura/SPDA (Escala 1:100)
- `AÇU-3.DES-2.3100-16-EGS-015 rev.0`: Diagrama Unifilar do Quadro de Luz e Força QL-204
- `AÇU-3.DES-2.3100-16-EGS-018 rev.0`: Arquitetura - Planta Baixa do Pavimento Térreo (Layout e Áreas Molhadas)
**Metodologia de Levantamento:** Escalímetro Digital Vetorial (Medição de segmentos vetoriais em PDF com calibração de malha estrutural) + Censo Unifilar de Carga  
