# 📘 MANUAL INTEGRADO DE DATABOOK, AS-BUILT E CLOSEOUT OPERACIONAL
**Empreendimento:** TMULT — Terminal Multiuso (Porto do Açu) — Edifício Administrativo (TMULT)  
**Código do Documento:** MD-DATABOOK-TMULT-01  
...
O presente manual normatiza todo o processo de encerramento contratual, documental e técnico do empreendimento **TMULT — Terminal Multiuso (Porto do Açu) — Edifício Administrativo**. 
...
├── MANUAL_DATABOOK_CLOSEOUT_TMULT.md
└── CONTROLE_DATABOOK_CLOSEOUT_TMULT.xlsx
```
...
O acompanhamento do status de cada documento obrigatório é gerido através da planilha executiva [CONTROLE_DATABOOK_CLOSEOUT_TMULT.xlsx](CONTROLE_DATABOOK_CLOSEOUT_TMULT.xlsx), com semáforos condicionais e percentual de prontidão para auditoria da Diretoria.
