...
> **Prazo Contratual:** 50 dias corridos (Semanas S12 a S20 | 01/12/2026 a 20/01/2027) | **Governança:** POP 17 / NR-18 / Skill Gestão 10

---

## CLÁUSULA PRIMEIRA — DO OBJETO
1.1. O presente contrato tem por objeto a execução, sob o regime de **Empreitada por Preço Unitário**, dos serviços de **Empreitada de Instalações Hidrossanitárias e Drenagem**, correspondente ao pacote **SUB-06** da Linha de Base 01 da RESIDENCIAL_ALPHA.
...
2.1. Pela execução dos serviços descritos no Anexo I, a CONTRATANTE pagará à CONTRATADA o valor global estimado de **R$ 38.900,00** (preço fechado dos serviços listados).
...
3.1. O prazo total de vigência executiva é de **50 dias corridos (Semanas S12 a S20 | 01/12/2026 a 20/01/2027)**, com início imediato após a emissão da Ordem de Serviço.
3.2. A CONTRATADA obriga-se a disponibilizar e manter no canteiro a equipe de pico de **2 encanadores industriais oficiais com ampla experiência**, sob pena de notificação e aplicação de multa por desmobilização imprevista.
...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| `2.1.1` | Tubulações de água fria em PVC soldável de 20 a 50mm embutidas | m | 240,00 | R$ 18,00 | **R$ 4.320,00** | `CC-601` |
| `2.1.2` | Tubulações de esgoto sanitário e ventilação em PVC série normal e reforçada | m | 180,00 | R$ 24,00 | **R$ 4.320,00** | `CC-602` |
| `2.1.3` | Instalação de caixas sifonadas, ralos secos e caixas de inspeção/gordura | un | 16,00 | R$ 85,00 | **R$ 1.360,00** | `CC-602` |
| `2.1.4` | Instalação de louças sanitárias Deca (bacias acopladas e lavatórios de coluna) | un | 12,00 | R$ 120,00 | **R$ 1.440,00** | `CC-603` |
| `2.1.5` | Instalação de metais Docol (torneiras temporizadas e registros de gaveta) | un | 18,00 | R$ 65,00 | **R$ 1.170,00** | `CC-603` |
| `2.1.6` | Mão de obra especializada de testes hidrostáticos, manômetro e laudo técnico | vb | 1,00 | R$ 26.290,00 | **R$ 26.290,00** | `CC-600` |

**VALOR TOTAL DO ANEXO I (REMUNERAÇÃO DA EMPREITADA):** **R$ 38.900,00**
...
- **Normas Regulamentadoras e Técnicas Aplicáveis:** ABNT NBR 5626 (Instalação Predial de Água Fria), NBR 8160 (Sistemas Prediais de Esgoto Sanitário) e NBR 10844;
- **Tolerâncias Máximas Admissíveis:** Declividade mínima de 2% para ramais de esgoto Ø <= 75mm e 1% para tubulações de 100mm; Estanqueidade absoluta sob teste de pressão de 10 bar (100 m.c.a.) sem queda manométrica durante 72 horas;
- **Portão Bloqueante de Qualidade (FVS):** FVS-HID-01 (Laudo do Teste Hidrostático de 72h - Portão Bloqueante 3);
...
- **A CONTRATANTE (Construtora) Fornece Exclusivamente:** Tubos e conexões PVC Tigre/Amanco, Adesivo plástico e solução limpadora, Louças e metais sanitários homologados, Caixas de gordura e esgoto prontas.;
- **A CONTRATADA (Empreiteiro) Fornece Obrigatoriamente:** Bomba de teste hidrostático manual/elétrica com manômetro com laudo de calibração recente, cortador de parede com aspirador, termofusora (se houver PPR), tarraxas para rosca BSP, maçaricos e ferramentas de encanador..
