...
> **Fórmula Truncada NBR 6118:** `V_sapata = V_base + V_tronco`  
> `V_base = B × L × h_rodapé (0,20m)`  
> `V_tronco = (h_tronco / 3) × [ A1 + A2 + √(A1 × A2) ]` (com Topo `A2 = 0,30m × 0,30m = 0,09 m²`)
- **11 Sapatas S1 (1,00m × 1,00m):** `V_base (0,200m³) + V_tronco (0,2317m³) = 0,4317 m³ / un` → Subtotal (11 un): `4,749 m³`
- **6 Sapatas S3 (1,10m × 1,10m):** `V_base (0,242m³) + V_tronco (0,2717m³) = 0,5137 m³ / un` → Subtotal (6 un): `3,082 m³`
- **9 Sapatas S7 (0,90m × 0,90m):** `V_base (0,162m³) + V_tronco (0,1950m³) = 0,3570 m³ / un` → Subtotal (9 un): `3,213 m³`
- **6 Sapatas SE1 (0,70m × 0,70m):** `V_base (0,098m³) + V_tronco (0,1317m³) = 0,2297 m³ / un` → Subtotal (6 un): `1,378 m³`
- **Volume Geral das 32 Sapatas Isoladas (Ajustado com tronco fôrma EGS-052):** **`8,55 m³`** (Com Perda 5%: **`8,98 m³`** - 2 betoneiras).
...
### 1.7 Impermeabilização Tinta Asfáltica (Topo e Laterais de Baldrames e Sapatas)
...
### 1.8 Reaterro Compactado e Bota-fora Líquidos
...
| **1.1.7** | Concreto Usinado fck 30 MPa para Vigas Baldrames VB1-VB19 (25x40cm - 140,44m) | 14.04 m³ | 5.0% | **14.74** | `m³ (2 betoneiras)` | `AÇU-3.DES-2.3100-11-EGS-053/054` |
| **1.1.8** | Fôrma Compensado Resinado 17mm para Vigas Baldrames (140,44m) | 112.35 m² | 10.0% | **52** | `chapas (125.84 m²)` | `AÇU-3.DES-2.3100-11-EGS-053/054` |
| **1.1.9** | Armadura CA-50 Ø8,0mm (Armadura das 32 Sapatas Isoladas) | 256.00 kg | 5.0% | **68** | `barras 12m (268.8 kg)` | `AÇU-3.DES-2.3100-11-EGS-052` |
| **1.1.10** | Armadura CA-50 Ø6,3mm / Ø12,5mm (Arranques dos Pilares P1-P24) | 145.70 kg | 5.0% | **38** | `barras 12m (153.0 kg)` | `AÇU-3.DES-2.3100-11-EGS-052` |
| **1.1.11** | Armadura CA-50 Vigas Baldrames VB1-VB19 (EGS-053: 694,8kg + EGS-054: 382,5kg) | 1077.30 kg | 5.0% | **199** | `barras 12m (1131.2 kg)` | `AÇU-3.DES-2.3100-11-EGS-053/054` |
| **1.1.12** | Arame Recozido BWG 18 para Amarrações de Fundação | 16.45 kg | 0.0% | **17.00** | `kg (17 rolos 1kg)` | `AÇU-3.DES-2.3100-11-EGS-052/053` |
| **1.1.13** | Espaçadores/Pastilhas de Concreto cobrimento 40mm/50mm | 640.00 unid | 5.0% | **672** | `unidades` | `AÇU-3.DES-2.3100-11-EGS-051/054` |
| **1.1.14** | Impermeabilização Tinta Asfáltica (Baldrames e Sapatas) | 183.36 m² | 10.0% | **201.70** | `m² (12 galões 18L)` | `AÇU-3.DES-2.3100-11-EGS-051/054` |
| **1.1.15** | Reaterro Compactado de Cavas e Valas c/ Maço/Sapo Líquido | 31.17 m³ | 0.0% | **31.17** | `m³` | `AÇU-3.DES-2.3100-11-EGS-051/052` |
| **1.1.16** | Bota-fora e Carga de Terra c/ Empolamento 1,25 Líquido | 20.10 m³ | 0.0% | **25.13** | `m³ (3 caminhões 12m³)` | `AÇU-3.DES-2.3100-11-EGS-051/052` |
