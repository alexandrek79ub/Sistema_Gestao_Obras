# 📄 INSTRUMENTO PARTICULAR DE CONTRATO DE EMPREITADA CIVIL: SUB-04
### EMPREITADA DE PISOS E PAVIMENTAÇÕES
...
> **Valor Total do Contrato:** R$ 36.800,00 | **Centro de Custo:** CC-704 (Pisos e Pavimentações)  
> **Prazo Contratual:** 28 dias corridos (Semanas S18 a S21 | 15/01/2027 a 12/02/2027) | **Governança:** POP 17 / NR-18 / Skill Gestão 10

---

## CLÁUSULA PRIMEIRA — DO OBJETO
1.1. O presente contrato tem por objeto a execução, sob o regime de **Empreitada por Preço Unitário**, dos serviços de **Empreitada de Pisos e Pavimentações**, correspondente ao pacote **SUB-04** da Linha de Base 01 da RESIDENCIAL_ALPHA.
1.2. O escopo compreende: Execução de regularização de contrapiso autonivelante e=3cm, assentamento de 368,40 m² de porcelanato 60x60cm retificado com argamassa AC-III dupla colagem, rodapés de porcelanato h=10cm e rejuntamento epóxi/resinado, estritamente de acordo com as especificações técnicas, projetos executivos, cadernos de encargos e normas vigentes.

## CLÁUSULA SEGUNDA — DO VALOR E DA FORMA DE PAGAMENTO
2.1. Pela execução dos serviços descritos no Anexo I, a CONTRATANTE pagará à CONTRATADA o valor global estimado de **R$ 36.800,00** (preço fechado dos serviços listados).
...
3.1. O prazo total de vigência executiva é de **28 dias corridos (Semanas S18 a S21 | 15/01/2027 a 12/02/2027)**, com início imediato após a emissão da Ordem de Serviço.
3.2. A CONTRATADA obriga-se a disponibilizar e manter no canteiro a equipe de pico de **3 ladrilhistas / azulejistas oficiais qualificados**, sob pena de notificação e aplicação de multa por desmobilização imprevista.
...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| `1.7.1` | Execução de contrapiso de regularização farofa e=3cm com impermeabilizante | m² | 368,40 | R$ 22,00 | **R$ 8.104,80** | `CC-704` |
| `1.7.2` | Assentamento de porcelanato retificado 60x60cm dupla colagem com AC-III | m² | 368,40 | R$ 48,00 | **R$ 17.683,20** | `CC-704` |
| `1.7.3` | Instalação de rodapé em porcelanato h=10cm cortado com meia esquadria | m | 180,00 | R$ 15,00 | **R$ 2.700,00** | `CC-704` |
| `1.7.4` | Aplicação de rejunte flexível resinado e epóxi anti-fungo em áreas molhadas | m² | 368,40 | R$ 8,00 | **R$ 2.947,20** | `CC-704` |
| `1.7.5` | Proteção superficial de pisos com papelão ondulado e fita crepe | vb | 1,00 | R$ 5.364,80 | **R$ 5.364,80** | `CC-704` |

**VALOR TOTAL DO ANEXO I (REMUNERAÇÃO DA EMPREITADA):** **R$ 36.800,00**
...
- **Normas Regulamentadoras e Técnicas Aplicáveis:** ABNT NBR 13753 (Revestimento de Piso Interno com Placas Cerâmicas) e NBR 15575;
- **Tolerâncias Máximas Admissíveis:** Desnível entre peças adjacentes (dente) <= 0,5mm; Desvio de planeza máximo de 2mm em régua de 2,00m; Juntas retilíneas de 2mm c/ espaçador nivelador; Aderência com eliminação de som oco em 100% da área;
- **Portão Bloqueante de Qualidade (FVS):** FVS-PIS-01 (Conferência de Nivelamento e Percussão Acústica de Pisos);
...
- **A CONTRATANTE (Construtora) Fornece Exclusivamente:** Porcelanatos 60x60cm retificados (mesmo lote de tonalidade), Cimento, Areia lavada, Argamassa AC-III ensacada, Rejunte resinado e epóxi, Papelão ondulado para forração.;
- **A CONTRATADA (Empreiteiro) Fornece Obrigatoriamente:** Cortadores de bancada elétricos refrigerados a água (Makita de mesa c/ disco diamantado contínuo), alicates de tração de niveladores, desempenadeiras de dente 8mm, martelos de borracha branca, ventosas duplas e espátulas de silicone..
