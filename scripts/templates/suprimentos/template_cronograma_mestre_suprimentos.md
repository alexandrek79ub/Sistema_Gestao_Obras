...
> **Empreendimento:** {{NOME_OBRA}} ({{AREA_M2}} m²)  
> **Horizonte Temporal:** {{PRAZO_MESES}} Meses ({{TOTAL_SEMANAS}} Semanas / {{TOTAL_DIAS}} Dias Corridos) — Linha de Base  
> **Governança:** POP 05, POP 06, POP 17 e Skill Gestão 03  
> **Data de Atualização:** {{DATA_ATUAL}} | **Engenheiro Chefe:** PMO Virtual
...
## 2. Cronograma de Suprimentos — MATERIAIS E INSUMOS CRÍTICOS ({{TOTAL_MATERIAIS}} Pacotes)
...
**Custo Direto Orçado dos Materiais:** {{VALOR_TOTAL_MATERIAIS}}

---

## 3. Cronograma de Suprimentos — EQUIPAMENTOS & INSTALAÇÕES PROVISÓRIAS ({{TOTAL_EQUIPAMENTOS}} Itens)
